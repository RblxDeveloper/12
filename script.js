document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateGist(redeemedCodes) {
        ...
        var requestOptions = {
            method: 'PATCH',
            headers: {
                'Authorization': 'Bearer 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', // Replace with your new GitHub personal access token
